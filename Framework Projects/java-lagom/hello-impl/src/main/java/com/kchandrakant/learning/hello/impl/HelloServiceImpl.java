...
import com.kchandrakant.learning.hello.api.GreetingMessage;
import com.kchandrakant.learning.hello.api.HelloService;
import com.kchandrakant.learning.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.kchandrakant.learning.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.kchandrakant.learning.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.kchandrakant.learning.hello.api.HelloEvent.GreetingMessageChanged(
